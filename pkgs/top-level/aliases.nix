...
mapAliases {
  ...
  _86box = _86Box; # Release only, compatibility alias from 2026-02-26
  _86box-with-roms = _86Box-with-roms; # Release only, compatibility alias from 2026-02-26
  ...
  amb-plugins = AMB-plugins; # Release only, compatibility alias from 2026-02-26
  ...
  anonymous-pro-fonts = anonymousPro; # Release only, compatibility alias from 2026-02-26
  ...
  arduino-ota = arduinoOTA; # Release only, compatibility alias from 2026-02-26
  ...
  b43-fwcutter = b43FirmwareCutter; # Release only, compatibility alias from 2026-02-26
  ...
  bash-snippets = bashSnippets; # Release only, compatibility alias from 2026-02-26
  ...
  cdktn-cli = cdktf-cli; # Release only, compatibility alias from 2026-02-26
  ...
  cisco-packet-tracer_8 = ciscoPacketTracer8; # Release only, compatibility alias from 2026-02-26
  ...
  clearly-u = clearlyU; # Release only, compatibility alias from 2026-02-26
  ...
  clucene-core = clucene_core; # Release only, compatibility alias from 2026-02-26
  clucene-core_2 = clucene_core_2; # Release only, compatibility alias from 2026-02-26
  ...
  commons-bcel = commonsBcel; # Release only, compatibility alias from 2026-02-26
  commons-bsf = commonsBsf; # Release only, compatibility alias from 2026-02-26
  commons-compress = commonsCompress; # Release only, compatibility alias from 2026-02-26
  commons-daemon = commonsDaemon; # Release only, compatibility alias from 2026-02-26
  commons-fileupload = commonsFileUpload; # Release only, compatibility alias from 2026-02-26
  commons-io = commonsIo; # Release only, compatibility alias from 2026-02-26
  commons-lang = commonsLang; # Release only, compatibility alias from 2026-02-26
  commons-logging = commonsLogging; # Release only, compatibility alias from 2026-02-26
  commons-math = commonsMath; # Release only, compatibility alias from 2026-02-26
  ...
  disnix-web-service = DisnixWebService; # Release only, compatibility alias from 2026-02-26
  ...
  enchant_2 = enchant2; # Release only, compatibility alias from 2026-02-26
  ...
  et-book = etBook; # Release only, compatibility alias from 2026-02-26
  ...
  faust-physicalmodeling = faustPhysicalModeling; # Release only, compatibility alias from 2026-02-26
  ...
  flatten-references-graph = flattenReferencesGraph; # Release only, compatibility alias from 2026-02-26
  ...
  fltk_1_3 = fltk13; # Release only, compatibility alias from 2026-02-26
  fltk_1_3-minimal = fltk13-minimal; # Release only, compatibility alias from 2026-02-26
  fltk_1_4 = fltk14; # Release only, compatibility alias from 2026-02-26
  fltk_1_4-minimal = fltk14-minimal; # Release only, compatibility alias from 2026-02-26
  ...
  fusioninventory-agent = fusionInventory; # Release only, compatibility alias from 2026-02-26
  ...
  gimagereader = gImageReader; # Release only, compatibility alias from 2026-02-26
  gimagereader-qt = gImageReader-qt; # Release only, compatibility alias from 2026-02-26
  ...
  glew_1_10 = glew110; # Release only, compatibility alias from 2026-02-26
  ...
  goocanvas_1 = goocanvas; # Release only, compatibility alias from 2026-02-26
  goocanvas_2 = goocanvas2; # Release only, compatibility alias from 2026-02-26
  goocanvas_3 = goocanvas3; # Release only, compatibility alias from 2026-02-26
  ...
  hydra-ant-logger = hydraAntLogger; # Release only, compatibility alias from 2026-02-26
  ...
  infamousplugins = infamousPlugins; # Release only, compatibility alias from 2026-02-26
  ...
  ipw2200-firmware = intel2200BGFirmware; # Release only, compatibility alias from 2026-02-26
  ir.lv2 = ir-lv2; # Added 2025-09-37
  ircd-hybrid = ircdHybrid; # Release only, compatibility alias from 2026-02-26
  ...
  java-cup = javaCup; # Release only, compatibility alias from 2026-02-26
  ...
  lastools = LAStools; # Release only, compatibility alias from 2026-02-26
  ...
  libdbi-drivers = libdbiDrivers; # Release only, compatibility alias from 2026-02-26
  libdbi-drivers-base = libdbiDriversBase; # Release only, compatibility alias from 2026-02-26
  ...
  libfakexinerama = libfakeXinerama; # Release only, compatibility alias from 2026-02-26
  libfastjson = fastJson; # Release only, compatibility alias from 2026-02-26
  ...
  libgdsii = libGDSII; # Release only, compatibility alias from 2026-02-26
  ...
  libhx = libHX; # Release only, compatibility alias from 2026-02-26
  ...
  liblas = libLAS; # Release only, compatibility alias from 2026-02-26
  liblastfm-vambrose = liblastfmSF; # Release only, compatibility alias from 2026-02-26
  ...
  linux-libertine-g = libertine-g; # Release only, compatibility alias from 2026-02-26
  ...
  lockfile-progs = lockfileProgs; # Release only, compatibility alias from 2026-02-26
  ...
  lycheeslicer = LycheeSlicer; # Release only, compatibility alias from 2026-02-26
  ...
  melonds = melonDS; # Release only, compatibility alias from 2026-02-26
  ...
  meters-lv2 = metersLv2; # Release only, compatibility alias from 2026-02-26
  ...
  mini-httpd = miniHttpd; # Release only, compatibility alias from 2026-02-26
  minizinc-ide = minizincide; # Release only, compatibility alias from 2026-02-26
  ...
  mma = MMA; # Release only, compatibility alias from 2026-02-26
  ...
  monkeys-audio = monkeysAudio; # Release only, compatibility alias from 2026-02-26
  ...
  moospace = mooSpace; # Release only, compatibility alias from 2026-02-26
  ...
  nuxmv = nuXmv; # Release only, compatibility alias from 2026-02-26
  ...
  onednn = oneDNN; # Release only, compatibility alias from 2026-02-26
  onednn_2 = oneDNN_2; # Release only, compatibility alias from 2026-02-26
  ...
  openal-soft = openalSoft; # Release only, compatibility alias from 2026-02-26
  openav-artyfx = artyFX; # Release only, compatibility alias from 2026-02-26
  ...
  opus-tools = opusTools; # Release only, compatibility alias from 2026-02-26
  ...
  pam-pgsql = pam_pgsql; # Release only, compatibility alias from 2026-02-26
  ...
  pcmciautils = pcmciaUtils; # Release only, compatibility alias from 2026-02-26
  ...
  primus-lib = primusLib; # Release only, compatibility alias from 2026-02-26
  prisma = prisma_6; # Added 2026-02-19
  prisma-engines = prisma-engines_6; # Added 2026-02-19
  ...
  pyca = pyCA; # Release only, compatibility alias from 2026-02-26
  ...
  qmasterpassword = qMasterPassword; # Release only, compatibility alias from 2026-02-26
  qmasterpassword-wayland = qMasterPassword-wayland; # Release only, compatibility alias from 2026-02-26
  ...
  rp-pppoe = rpPPPoE; # Release only, compatibility alias from 2026-02-26
  ...
  sequoia-sop = sequoia-sqop; # Release only, compatibility alias from 2026-02-26
  ...
  simple-tpm-pk11 = simpleTpmPk11; # Release only, compatibility alias from 2026-02-26
  simplebluez = simpleBluez; # Release only, compatibility alias from 2026-02-26
  simpledbus = simpleDBus; # Release only, compatibility alias from 2026-02-26
  ...
  speed-dreams = speed_dreams; # Release only, compatibility alias from 2026-02-26
  ...
  stalwart = stalwart-mail; # Release only, compatibility alias from 2026-02-26
  ...
  supertux = superTux; # Release only, compatibility alias from 2026-02-26
  supertuxkart = superTuxKart; # Release only, compatibility alias from 2026-02-26
  surge-xt = surge-XT; # Release only, compatibility alias from 2026-02-26
  svt-av1-psyex = svt-av1-psy; # Release only, compatibility alias from 2026-02-26
  ...
  wxsvg = wxSVG; # Release only, compatibility alias from 2026-02-26
  ...
  xf86-input-cmt = xf86_input_cmt; # Release only, compatibility alias from 2026-02-26
  xf86-input-evdev = xorg.xf86inputevdev; # Release only, compatibility alias from 2026-02-26
  xf86-input-joystick = xorg.xf86inputjoystick; # Release only, compatibility alias from 2026-02-26
  xf86-input-keyboard = xorg.xf86inputkeyboard; # Release only, compatibility alias from 2026-02-26
  xf86-input-libinput = xorg.xf86inputlibinput; # Release only, compatibility alias from 2026-02-26
  xf86-input-mouse = xorg.xf86inputmouse; # Release only, compatibility alias from 2026-02-26
  xf86-input-synaptics = xorg.xf86inputsynaptics; # Release only, compatibility alias from 2026-02-26
  xf86-input-vmmouse = xorg.xf86inputvmmouse; # Release only, compatibility alias from 2026-02-26
  xf86-input-void = xorg.xf86inputvoid; # Release only, compatibility alias from 2026-02-26
  xf86-input-wacom = xf86_input_wacom; # Release only, compatibility alias from 2026-02-26
  xf86-video-amdgpu = xorg.xf86videoamdgpu; # Release only, compatibility alias from 2026-02-26
  xf86-video-apm = xorg.xf86videoapm; # Release only, compatibility alias from 2026-02-26
  xf86-video-ark = xorg.xf86videoark; # Release only, compatibility alias from 2026-02-26
  xf86-video-ast = xorg.xf86videoast; # Release only, compatibility alias from 2026-02-26
  xf86-video-ati = xorg.xf86videoati; # Release only, compatibility alias from 2026-02-26
  xf86-video-chips = xorg.xf86videochips; # Release only, compatibility alias from 2026-02-26
  xf86-video-cirrus = xorg.xf86videocirrus; # Release only, compatibility alias from 2026-02-26
  xf86-video-dummy = xorg.xf86videodummy; # Release only, compatibility alias from 2026-02-26
  xf86-video-fbdev = xorg.xf86videofbdev; # Release only, compatibility alias from 2026-02-26
  xf86-video-geode = xorg.xf86videogeode; # Release only, compatibility alias from 2026-02-26
  xf86-video-i128 = xorg.xf86videoi128; # Release only, compatibility alias from 2026-02-26
  xf86-video-i740 = xorg.xf86videoi740; # Release only, compatibility alias from 2026-02-26
  xf86-video-intel = xorg.xf86videointel; # Release only, compatibility alias from 2026-02-26
  xf86-video-mga = xorg.xf86videomga; # Release only, compatibility alias from 2026-02-26
  xf86-video-neomagic = xorg.xf86videoneomagic; # Release only, compatibility alias from 2026-02-26
  xf86-video-nested = xf86_video_nested; # Release only, compatibility alias from 2026-02-26
  xf86-video-nouveau = xorg.xf86videonouveau; # Release only, compatibility alias from 2026-02-26
  xf86-video-nv = xorg.xf86videonv; # Release only, compatibility alias from 2026-02-26
  xf86-video-omap = xorg.xf86videoomap; # Release only, compatibility alias from 2026-02-26
  xf86-video-openchrome = xorg.xf86videoopenchrome; # Release only, compatibility alias from 2026-02-26
  xf86-video-qxl = xorg.xf86videoqxl; # Release only, compatibility alias from 2026-02-26
  xf86-video-r128 = xorg.xf86videor128; # Release only, compatibility alias from 2026-02-26
  xf86-video-s3virge = xorg.xf86videos3virge; # Release only, compatibility alias from 2026-02-26
  xf86-video-savage = xorg.xf86videosavage; # Release only, compatibility alias from 2026-02-26
  xf86-video-siliconmotion = xorg.xf86videosiliconmotion; # Release only, compatibility alias from 2026-02-26
  xf86-video-sis = xorg.xf86videosis; # Release only, compatibility alias from 2026-02-26
  xf86-video-sisusb = xorg.xf86videosisusb; # Release only, compatibility alias from 2026-02-26
  xf86-video-suncg6 = xorg.xf86videosuncg6; # Release only, compatibility alias from 2026-02-26
  xf86-video-sunffb = xorg.xf86videosunffb; # Release only, compatibility alias from 2026-02-26
  xf86-video-sunleo = xorg.xf86videosunleo; # Release only, compatibility alias from 2026-02-26
  xf86-video-tdfx = xorg.xf86videotdfx; # Release only, compatibility alias from 2026-02-26
  xf86-video-trident = xorg.xf86videotrident; # Release only, compatibility alias from 2026-02-26
  xf86-video-v4l = xorg.xf86videov4l; # Release only, compatibility alias from 2026-02-26
  xf86-video-vbox = xorg.xf86videovboxvideo; # Release only, compatibility alias from 2026-02-26
  xf86-video-vesa = xorg.xf86videovesa; # Release only, compatibility alias from 2026-02-26
  xf86-video-vmware = xorg.xf86videovmware; # Release only, compatibility alias from 2026-02-26
  xf86-video-voodoo = xorg.xf86videovoodoo; # Release only, compatibility alias from 2026-02-26
  ...
  xkeyboard-config_custom = xorg.xkeyboardconfig_custom; # Release only, compatibility alias from 2026-02-26
  ...
  xorg-server = xorg.xorgserver; # Release only, compatibility alias from 2026-02-26
  ...
  yargen = yarGen; # Release only, compatibility alias from 2026-02-26
  ...
  zmkbatx = zmkBATx; # Release only, compatibility alias from 2026-02-26
